...
exports.User = void 0;
var common_entity_1 = require("@/common/common.entity");
...
var User = function () {
    ...
    var _classThis;
    var _classSuper = common_entity_1.CommonEntity;
    ...
    var User = _classThis = /** @class */ (function (_super) {
        ...
        function User_1() {
            ...
            _this.email = (__runInitializers(_this, _fullName_extraInitializers), __runInitializers(_this, _email_initializers, void 0));
            _this.password = (__runInitializers(_this, _email_extraInitializers), __runInitializers(_this, _password_initializers, void 0));
            _this.bio = (__runInitializers(_this, _password_extraInitializers), __runInitializers(_this, _bio_initializers, ""));
            __runInitializers(_this, _bio_extraInitializers);
            return _this;
        }
        return User_1;
    }(_classSuper));
    ...
    (function () {
        ...
        _fullName_decorators = [(0, core_1.Property)()];
        _email_decorators = [(0, core_1.Property)()];
        _password_decorators = [(0, core_1.Property)()];
        _bio_decorators = [(0, core_1.Property)({ type: "text" })];
